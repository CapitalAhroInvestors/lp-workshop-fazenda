...
export const PLANS = {
  basic: {
    ...
    price: 67,
    nextLotPrice: 97,
    checkoutUrl: 'https://payfast.greenn.com.br/redirect/290120',
    upsellPrice: 87,
    upsellCheckoutUrl: 'https://payfast.greenn.com.br/redirect/291986',
    features: [
  ...
  premium: {
    ...
    price: 97,
    nextLotPrice: 127,
    checkoutUrl: 'https://payfast.greenn.com.br/redirect/291982',
    highlight: true,
