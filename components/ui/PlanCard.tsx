          ...
          <div className="absolute -top-5 left-1/2 z-20 -translate-x-1/2">
            <div className="relative">
              <div
                ...
                style={{ background: 'rgba(34,197,94,0.7)', animation: 'pulse 2s ease-in-out infinite' }}
                aria-hidden="true"
              />
              <div
              ...
              >
                <span className="btn-shimmer pointer-events-none absolute inset-0" style={{ background: 'linear-gradient(105deg, transparent 30%, rgba(255,255,255,0.4) 50%, transparent 70%)' }} />
          ...
          <div className="mt-auto">
            {highlight ? (
              <button
                ...
                style={{ background: 'linear-gradient(90deg, #16a34a, #4ade80, #22c55e, #4ade80, #16a34a)' }}
              >
                <span className="btn-shimmer pointer-events-none absolute inset-0" style={{ background: 'linear-gradient(105deg, transparent 30%, rgba(255,255,255,0.35) 50%, transparent 70%)' }} />
              ...
              >
                <span className="btn-shimmer-slow pointer-events-none absolute inset-0" style={{ background: 'linear-gradient(105deg, transparent 30%, rgba(255,255,255,0.2) 50%, transparent 70%)' }} />
                <span className="relative z-10">Quero por R$ {fmtPrice(price)}</span>
              </button>
            )}
          </div>
