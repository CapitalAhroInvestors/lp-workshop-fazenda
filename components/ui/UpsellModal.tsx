...
export default function UpsellModal({
  ...
  return (
    <div
      className={`modal-overlay fixed inset-0 z-50 bg-black/80 backdrop-blur-sm ${open ? 'modal-open' : ''}`}
      onClick={onClose}
    >
      <div className="flex h-full items-center justify-center p-4">
        <div
          className="modal-panel relative w-full max-w-[440px] overflow-hidden rounded-2xl border border-[var(--border-glow)] bg-[var(--bg-card)] shadow-[0_0_60px_rgba(74,222,128,0.2)]"
        ...
        >
          ...
          <div className="flex flex-col gap-3 px-6 pb-6">
            ...
            >
              <span className="btn-shimmer pointer-events-none absolute inset-0" style={{ background: 'linear-gradient(105deg, transparent 30%, rgba(255,255,255,0.3) 50%, transparent 70%)' }} />
